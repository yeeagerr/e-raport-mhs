<form class="relative w-96 h-[500px]" action="{{route('update_admin_post', $user->id)}}" method="POST">
    @csrf
    @method("PUT")
    <div
        ...
        <h2 class="relative text-2xl text-white font-bold text-black text-center">UPDATE AS GURU</h2>
    </div>
    ...
    <div
        ...
        <input
            ...
            type="username"  name="username" value="{{$user->username}}" />
        <div
